...
if __name__ == '__main__':
    ...
    parser.add_argument("-p1", help="Start coordinate of mRNA", required=True)
    parser.add_argument("-p2", help="Last coordinate of mRNA before PolyA tract", required=True)
